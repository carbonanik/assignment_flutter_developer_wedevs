...
abstract class $ProductListResponseCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "variations") List<int>? variations,
...
class _$ProductListResponseImpl implements _ProductListResponse {
  const _$ProductListResponseImpl(
      ...
      @JsonKey(name: "upsell_ids") final List<dynamic>? upsellIds,
      @JsonKey(name: "cross_sell_ids") final List<dynamic>? crossSellIds,
      ...
      @JsonKey(name: "variations") final List<int>? variations,
  ...
  @override
  String toString() {
    return 'ProductListResponse(id: $id, name: $name, slug: $slug, postAuthor: $postAuthor, permalink: $permalink, dateCreated: $dateCreated, dateCreatedGmt: $dateCreatedGmt, dateModified: $dateModified, dateModifiedGmt: $dateModifiedGmt, type: $type, status: $status, featured: $featured, catalogVisibility: $catalogVisibility, description: $description, shortDescription: $shortDescription, sku: $sku, price: $price, regularPrice: $regularPrice, salePrice: $salePrice, dateOnSaleFrom: $dateOnSaleFrom, dateOnSaleFromGmt: $dateOnSaleFromGmt, dateOnSaleTo: $dateOnSaleTo, dateOnSaleToGmt: $dateOnSaleToGmt, priceHtml: $priceHtml, onSale: $onSale, purchasable: $purchasable, totalSales: $totalSales, virtual: $virtual, downloadable: $downloadable, downloads: $downloads, downloadLimit: $downloadLimit, downloadExpiry: $downloadExpiry, externalUrl: $externalUrl, buttonText: $buttonText, taxStatus: $taxStatus, taxClass: $taxClass, manageStock: $manageStock, stockQuantity: $stockQuantity, lowStockAmount: $lowStockAmount, inStock: $inStock, backorders: $backorders, backordersAllowed: $backordersAllowed, backordered: $backordered, soldIndividually: $soldIndividually, weight: $weight, dimensions: $dimensions, shippingRequired: $shippingRequired, shippingTaxable: $shippingTaxable, shippingClass: $shippingClass, shippingClassId: $shippingClassId, reviewsAllowed: $reviewsAllowed, averageRating: $averageRating, ratingCount: $ratingCount, relatedIds: $relatedIds, upsellIds: $upsellIds, crossSellIds: $crossSellIds, parentId: $parentId, purchaseNote: $purchaseNote, categories: $categories, tags: $tags, images: $images, attributes: $attributes, defaultAttributes: $defaultAttributes, variations: $variations, groupedProducts: $groupedProducts, menuOrder: $menuOrder, metaData: $metaData, store: $store, links: $links)';
  }
...
abstract class _ProductListResponse implements ProductListResponse {
  const factory _ProductListResponse(
      ...
      @JsonKey(name: "low_stock_amount") final dynamic lowStockAmount,
      ...
      @JsonKey(name: "_links") final Links? links}) = _$ProductListResponseImpl;
...
class _$AttributeImpl implements _Attribute {
  ...
  @override
  String toString() {
    return 'Attribute(id: $id, slug: $slug, name: $name, position: $position, visible: $visible, variation: $variation, options: $options)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, slug, name, position,
      visible, variation, const DeepCollectionEquality().hash(_options));
...
abstract class _Attribute implements Attribute {
  const factory _Attribute(
      ...
      @JsonKey(name: "variation") final bool? variation,
      @JsonKey(name: "options") final List<String>? options}) = _$AttributeImpl;
...
abstract class _MetaDatum implements MetaDatum {
  const factory _MetaDatum(
      ...
      @JsonKey(name: "value") final dynamic value}) = _$MetaDatumImpl;
...
mixin _$ValueClass {
  ...
  String? get enableWholesale => throw _privateConstructorUsedError;
  @JsonKey(name: "price")
  String? get price => throw _privateConstructorUsedError;
...
abstract class $ValueClassCopyWith<$Res> {
  factory $ValueClassCopyWith(
      ...
      _$ValueClassCopyWithImpl<$Res, ValueClass>;
  @useResult
  $Res call(
      {@JsonKey(name: "enable_wholesale") String? enableWholesale,
      @JsonKey(name: "price") String? price,
      @JsonKey(name: "quantity") dynamic quantity});
}

/// @nodoc
class _$ValueClassCopyWithImpl<$Res, $Val extends ValueClass>
  ...
  @override
  $Res call({
    Object? enableWholesale = freezed,
    Object? price = freezed,
    Object? quantity = freezed,
  }) {
    return _then(_value.copyWith(
      enableWholesale: freezed == enableWholesale
          ? _value.enableWholesale
          : enableWholesale // ignore: cast_nullable_to_non_nullable
              as String?,
      price: freezed == price
          ? _value.price
          : price // ignore: cast_nullable_to_non_nullable
...
/// @nodoc
abstract class _$$ValueClassImplCopyWith<$Res>
    implements $ValueClassCopyWith<$Res> {
  factory _$$ValueClassImplCopyWith(
          _$ValueClassImpl value, $Res Function(_$ValueClassImpl) then) =
      __$$ValueClassImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "enable_wholesale") String? enableWholesale,
...
/// @nodoc
class __$$ValueClassImplCopyWithImpl<$Res>
    extends _$ValueClassCopyWithImpl<$Res, _$ValueClassImpl>
    implements _$$ValueClassImplCopyWith<$Res> {
  __$$ValueClassImplCopyWithImpl(
      _$ValueClassImpl _value, $Res Function(_$ValueClassImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$ValueClassImpl implements _ValueClass {
  const _$ValueClassImpl(
      {@JsonKey(name: "enable_wholesale") this.enableWholesale,
      @JsonKey(name: "price") this.price,
      @JsonKey(name: "quantity") this.quantity});

  factory _$ValueClassImpl.fromJson(Map<String, dynamic> json) =>
      _$$ValueClassImplFromJson(json);
  ...
  @override
  String toString() {
    return 'ValueClass(enableWholesale: $enableWholesale, price: $price, quantity: $quantity)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ValueClassImpl &&
            (identical(other.enableWholesale, enableWholesale) ||
                other.enableWholesale == enableWholesale) &&
            (identical(other.price, price) || other.price == price) &&
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, enableWholesale, price,
      const DeepCollectionEquality().hash(quantity));

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$ValueClassImplCopyWith<_$ValueClassImpl> get copyWith =>
      __$$ValueClassImplCopyWithImpl<_$ValueClassImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ValueClassImplToJson(
      this,
    );
  }
}
...
abstract class _ValueClass implements ValueClass {
  const factory _ValueClass(
      {@JsonKey(name: "enable_wholesale") final String? enableWholesale,
      @JsonKey(name: "price") final String? price,
      @JsonKey(name: "quantity") final dynamic quantity}) = _$ValueClassImpl;

  factory _ValueClass.fromJson(Map<String, dynamic> json) =
      _$ValueClassImpl.fromJson;

  @override
  @JsonKey(name: "enable_wholesale")
  String? get enableWholesale;
  @override
  @JsonKey(name: "price")
  String? get price;
  @override
